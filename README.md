## Please note this repo is still under construction
...
>ZM4.fa: compilation of *Z. mobilis* ZM4 chromosome and plasmid sequences from [1] (#citations)    
>Thomason_2015.EcoTSS.bed: *E. coli* TSS annotations used as input for this study [2]   
>Zhou_2015.CcrTSS.bed: *C. crescentus* TSS annotations used as input for this study [3]     
>Zymo.up100.promoters.fa: 3080 *Z. mobilis* TSS annotations from 
